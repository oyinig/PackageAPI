...
public class PackageController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PackageDTO> updatePackage(@PathVariable Long id, @RequestBody PackageRequest pkg) {
        PackageDTO updatedPackage = packageService.updatePackage(id, pkg);
